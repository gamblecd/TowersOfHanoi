...
public interface Playable {
	...
	/**
	 * Returns true if the current game is over. Once a game is over, next() should not be 
	...
	/**
	 * Performs one cycle or turn for the game. The workings of the game are determined by the 
	...
	/**
	 * Resets the game to the state that would be returned immediately after createNewGame().
	 */
