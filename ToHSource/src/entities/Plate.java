...
public class Plate implements Comparable<Plate>, HasSize, CLInteraction,
	...
	/**
	 * Creates a new plate of the given size, and default string representation.
	 * Plate sizes can only be positive values.
	 * 
	 * @param size
	 *            the size of the plate. Must be non-negative.
	 */
	...
	/**
	 * Creates a new plate of the given size, and will represent the plate in
	 * string format by unit. For best appearances the length of unit should be
	 * 2. Plate sizes can only be positive values.
	 * 
	 * @param size
	 *            the size of the plate. Must be non-negative.
	 * @param unit
	 *            the way to represent one unit of size. For best looks, should
	 *            only be a String of length 2.
	 */
